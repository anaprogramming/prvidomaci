...
if (isset($_POST['add'])) {
    ...
    if (empty($_POST['type'])) {
        $errors['type'] = 'Type of gym is required!';
    } else {
        $type = $_POST['type'];
    }
...
<section class="container">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="white form" method="POST">
        ...
        <label for="type">Type of gym:</label>
        ...
        <div class="center">
            <input type="submit" name="add" value="Post a Gym" class="btn grey darken-2 z-depth-0">
        </div>
    </form>
